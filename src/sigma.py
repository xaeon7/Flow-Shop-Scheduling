...
class StartScreen(QMainWindow):
    def __init__(self):
        ...
        loadUi("src/screens/start.ui",self)
        ...
        #? Handle navigation
        navigation.handleStartPageNavigation(self)
...
class JobsMatrixInput(QMainWindow):
    ...
    def __init__(self):
        ...
        #? load Ui file
        loadUi("src/screens/jobsMatrix.ui",self)
        ...
        #? Create a table with n columns and m jobs
...
class DelayInput(QMainWindow):
    def __init__(self):
        ...
        loadUi("src/screens/delay.ui",self)
        ...
        #? Handle file import
        self.importButton.clicked.connect(lambda :self.importDelay(2,2))
    ...
    def importDelay(self,initCol,initRow):
        self.errorType = 0
...
class PrepInput(QMainWindow):
    def __init__(self):
        ...
        loadUi("src/screens/inputPrep.ui",self)
        self.loadTab()
...
class DisplayGantt(QMainWindow):
    def __init__(self):
        ...
        loadUi("src/screens/plots.ui",self)
